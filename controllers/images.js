    ...
    insertImages: async (req, res) => {
        ...
        if (data.img0 != null) {
            storeImage(data.img0, shortId(), (err, url) => {
                if (url != null) {
                    Gallery.findOneAndUpdate({ _id: gallery.id }, { $set: { img0: url } }).exec();
                }
            });
        }
        if (data.img1 != null) {
            storeImage(data.img1, shortId(), (err, url) => {
                if (url != null) {
                    Gallery.findOneAndUpdate({ _id: gallery.id }, { $set: { img1: url } }).exec();
                }
            });
        }
        if (data.img2 != null) {
            storeImage(data.img2, shortId(), (err, url) => {
                if (url != null) {
                    Gallery.findOneAndUpdate({ _id: gallery.id }, { $set: { img2: url } }).exec();
                }
            });
        }
        if (data.img3 != null) {
            storeImage(data.img3, shortId(), (err, url) => {
                if (url != null) {
                    Gallery.findOneAndUpdate({ _id: gallery.id }, { $set: { img3: url } }).exec();
                }
            });
        }
        if (data.img4 != null) {
            storeImage(data.img4, shortId(), (err, url) => {
                if (url != null) {
                    Gallery.findOneAndUpdate({ _id: gallery.id }, { $set: { img4: url } }).exec();
                }
            });
        }
